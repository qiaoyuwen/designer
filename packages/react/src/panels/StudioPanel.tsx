...
const StudioPanelInternal: FunctionComponent<PropsWithChildren<IStudioPanelProps>> = ({ logo, actions, ...props }) => {
...
export const StudioPanel: FunctionComponent<PropsWithChildren<IStudioPanelProps>> = (props) => {
  return (
