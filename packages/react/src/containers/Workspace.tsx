import React, { useMemo, useRef, Fragment, PropsWithChildren } from 'react';
...
export const Workspace: React.FC<PropsWithChildren<IWorkspaceProps>> = ({ id, title, description, ...props }) => {
