...
import type { Breakpoint, ScreenMap } from 'antd/lib/_util/responsiveObserve';
import ResponsiveObserve, { responsiveArray } from 'antd/lib/_util/responsiveObserve';
...
function getFilledItem(node: React.ReactElement, span: number | undefined, rowRestCol: number): React.ReactElement {
  let clone = node;
