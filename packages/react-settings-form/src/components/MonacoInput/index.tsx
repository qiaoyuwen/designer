...
import { TextWidget, IconWidget, usePrefix, useTheme } from '@designer/react';
...
export interface IMonacoInputProps extends EditorProps {
...
export const MonacoInput: React.FC<IMonacoInputProps> & {
