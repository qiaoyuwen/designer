...
export class DragDropDriver extends EventDriver<Engine> {
  public mouseDownTimer: number = null;

  public startEvent: MouseEvent;
  ...
  public onMouseMove = (e: MouseEvent | DragEvent) => {
  ...
  public onContextMenuWhileDragging = (e: MouseEvent) => {
    e.preventDefault();
  };

  public onStartDrag = (e: MouseEvent | DragEvent) => {
  ...
  public onDistanceChange = (e: MouseEvent) => {
