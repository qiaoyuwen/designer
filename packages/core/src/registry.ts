...
const getISOCode = (language: string) => {
  ...
  each(DESIGNER_LOCALES_STORE.value, (value, key: string) => {
...
export type IDesignerRegistry = typeof DesignerGlobalRegistry;

export const GlobalRegistry: IDesignerRegistry = DesignerGlobalRegistry;
